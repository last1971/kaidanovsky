...
@section('content')
    <main>
        <h1>Политика конфиденциальности DON.RU</h1>
        <p>Настоящий документ «<a href="/privacy">Политика конфиденциальности</a>» (далее по тексту – «Политика») представляет собой правила использования сайта DON.RU (далее – «мы» и/или «Администрация») данных интернет-пользователей (далее «вы» и/или «Пользователь»), собираемых с использованием сайта don.ru (далее – «Сайт»).</p>
        ...
        <p></p><div class="info"> <strong>Пример!</strong> К указанному программному обеспечению третьих лиц относятся системы сбора статистики посещений Google Analytics и Яндекс.Метрика.</div><p></p>
        ...
        <p>5.2. Действующая редакция Политики находится на Сайте в сети Интернет по адресу <a href="/privacy">don.ru/privacy</a><br>Действующая редакция Политики от 01.08.2021 г.</p>
    </main>
@endsection
