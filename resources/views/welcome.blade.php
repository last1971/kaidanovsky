...
@section('content')
    <main>
        ...
        <p>
            Закажите и получите по почте юбилейную открытку с гашением почтовым штемпелем фиксированной даты. Мы отправим её вам 23 июля 2021г. из Ростова-на-Дону. Стоимость открытки 420 - 480 рублей, доставка в любую точку планеты Земля вхоит в стоимость.
        </p>
        ...
        <p>Оба варианта юбилейной открытки созданы замечательным ростованином - Владимиром Овекиным. Созданы с любовью.</p>
        <div>
